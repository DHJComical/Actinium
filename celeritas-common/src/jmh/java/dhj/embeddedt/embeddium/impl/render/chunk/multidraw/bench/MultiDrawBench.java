package dhj.embeddedt.embeddium.impl.render.chunk.multidraw.bench;
...
import dhj.embeddedt.embeddium.impl.render.chunk.bench.voxel.VoxelSectionBuilder;
...
import dhj.embeddedt.embeddium.impl.render.chunk.lists.VisibleChunkCollector;
...
import dhj.embeddedt.embeddium.impl.render.chunk.occlusion.bench.BenchPlatform;
import dhj.embeddedt.embeddium.impl.render.chunk.occlusion.bench.Cameras;
import dhj.embeddedt.embeddium.impl.render.chunk.occlusion.bench.SyntheticWorld;
import dhj.embeddedt.embeddium.impl.render.chunk.occlusion.bench.WorldType;
...
public class MultiDrawBench {
    ...
    public static class FrameState {
        ...
        /** See {@link dhj.embeddedt.embeddium.impl.render.chunk.bench.voxel.VoxelWorld#DEFAULT_CAVE_WIDTH}. */
        @Param({ "0.03" })
    ...
    private static int emit(FrameState state, TerrainRenderPass pass) {
        ...
        while (iterator.hasNext()) {
            ...
            var batch = BatchAssembler.fillRegion(region, storage, renderList, camera, pass, useBlockFaceCulling, MultiDrawMode.DIRECT);
