...
public class OcclusionCullerBench {
    ...
    public static class WorldState {
        ...
        public void setup() {
            ...
            // Pure CPU benchmark: no shadow pass, so the lattice is created without one.
        ...
        public void search(OcclusionCuller.Visitor visitor, Viewport viewport) {
            ...
            // allowFrustumClamping=true matches the main-path search behaviour in production.
            this.lattice.findVisible(visitor, viewport, this.searchDistance, this.numRegions, true, true,
                    this.nextFrame());
        }
