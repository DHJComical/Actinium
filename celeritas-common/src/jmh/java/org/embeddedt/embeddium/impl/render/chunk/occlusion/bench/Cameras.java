...
public final class Cameras {
    ...
    public static double surfaceCameraY(int sectionX, int sectionZ) {
        // Inlined from SyntheticWorld.surfaceSectionY (that class is not part of this port; it needs a GL context).
        int sectionY = (int) Math.floor(VoxelWorld.sectionHeight(sectionX, sectionZ));
        return (sectionY << 4) + 9.62;
    }
}
