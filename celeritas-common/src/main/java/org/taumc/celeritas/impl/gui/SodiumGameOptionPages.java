    ...
    public static OptionPage debug() {
        ...
        groups.add(OptionGroup.createBuilder()
                ...
                .add(OptionImpl.createBuilder(boolean.class, sodiumOpts)
                        ...
                        .build())
                .add(OptionImpl.createBuilder(boolean.class, sodiumOpts)
                        .setId(StandardOptions.Option.GNETUM_HUD_DEBUG.cast())
                        .setName(TextComponent.translatable("gnetum.options.hud_debug.name"))
                        .setTooltip(TextComponent.translatable("gnetum.options.hud_debug.tooltip"))
                        .setControl(TickBoxControl::new)
                        .setImpact(OptionImpact.HIGH)
                        .setBinding((opts, value) -> opts.debug.enableGnetumHudDebug = value, opts -> opts.debug.enableGnetumHudDebug)
                        .build())
                .add(OptionImpl.createBuilder(boolean.class, sodiumOpts)
