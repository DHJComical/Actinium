...
import org.embeddedt.embeddium.api.options.control.*;
import org.embeddedt.embeddium.api.options.structure.Option;
import org.taumc.celeritas.CeleritasVintage;

final class CurrentControlMapper {
    private CurrentControlMapper() {
    }
    ...
    private static IllegalArgumentException unsupported(Object source) {
        String message = "Unsupported current option control: " + source.getClass().getName();
