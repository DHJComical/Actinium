...
/**
 * Stable identifiers exposed by the legacy Celeritas options API.
 */
public final class StandardOptions {
    private static final String EMBEDDIUM_MOD_ID = "embeddium";
    private static final String ACTINIUM_MOD_ID = "actinium";
    ...
    public static class Group {
        ...
        public static final OptionIdentifier<Void> ACTINIUM_DEBUG = OptionIdentifier.create(ACTINIUM_MOD_ID, "debug");
    }
    ...
    public static class Pages {
        ...
        public static final OptionIdentifier<Void> DEBUG = OptionIdentifier.create(ACTINIUM_MOD_ID, "debug");
    }
    ...
    public static class Option {
        ...
        public static final OptionIdentifier<Void> STREAMING_UPLOAD_STRATEGY = OptionIdentifier.create(ACTINIUM_MOD_ID, "streaming_upload_strategy");
        public static final OptionIdentifier<Void> DEFERRED_PARTICLE_BATCHING = OptionIdentifier.create(ACTINIUM_MOD_ID, "deferred_particle_batching");
        public static final OptionIdentifier<Void> ALLOW_DIRECT_MEMORY_ACCESS = OptionIdentifier.create(ACTINIUM_MOD_ID, "allow_direct_memory_access");
        public static final OptionIdentifier<Void> MODEL_RENDERER_BATCHING = OptionIdentifier.create(ACTINIUM_MOD_ID, "model_renderer_batching");
        public static final OptionIdentifier<Void> MODEL_RENDERER_DISPLAY_LISTS = OptionIdentifier.create(ACTINIUM_MOD_ID, "model_renderer_display_lists");
        public static final OptionIdentifier<Void> FAST_LIT_ITEM_RENDERING = OptionIdentifier.create(ACTINIUM_MOD_ID, "fast_lit_item_rendering");
        public static final OptionIdentifier<Void> FAST_LIT_ITEM_DISPLAY_LISTS = OptionIdentifier.create(ACTINIUM_MOD_ID, "fast_lit_item_display_lists");
        ...
        public static final OptionIdentifier<Void> ACTINIUM_LWJGL_DEBUG = OptionIdentifier.create(ACTINIUM_MOD_ID, "lwjgl_debug");
        ...
        public static final OptionIdentifier<Void> ACTINIUM_FRAME_GL_ERROR_CHECK = OptionIdentifier.create(ACTINIUM_MOD_ID, "frame_gl_error_check");
        public static final OptionIdentifier<Void> ACTINIUM_POST_RENDER_GL_ERROR_CHECK = OptionIdentifier.create(ACTINIUM_MOD_ID, "post_render_gl_error_check");
        public static final OptionIdentifier<Void> ACTINIUM_REDIRECTOR_DEBUG = OptionIdentifier.create(ACTINIUM_MOD_ID, "redirector_debug");
        public static final OptionIdentifier<Void> ACTINIUM_REDIRECTOR_LOG_SPAM = OptionIdentifier.create(ACTINIUM_MOD_ID, "redirector_log_spam");
        public static final OptionIdentifier<Void> ACTINIUM_REDIRECTOR_CLASS_DUMP = OptionIdentifier.create(ACTINIUM_MOD_ID, "redirector_class_dump");
    }
}
