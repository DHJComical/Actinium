...
public class Color4 implements ISettableState<Color4> {
    ...
    public boolean sameAs(Object state) {
        ...
        return Float.compare(color4.red, red) == 0
            && Float.compare(color4.green, green) == 0
            && Float.compare(color4.blue, blue) == 0
            && Float.compare(color4.alpha, alpha) == 0;
    }
