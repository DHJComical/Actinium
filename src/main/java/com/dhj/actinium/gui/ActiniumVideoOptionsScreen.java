...
public class ActiniumVideoOptionsScreen extends GuiScreen {
    private final GuiScreen prevScreen;
    private final CeleritasVideoOptionsController controller;

    private int lastMouseX, lastMouseY;

    public ActiniumVideoOptionsScreen(GuiScreen prevScreen) {
        super();
        ...
        this.controller = new CeleritasVideoOptionsController(() -> this.mc.displayGuiScreen(this.prevScreen), Arrays.asList(
            ...
            protected void createExtraTabs(Map<String, List<Tab<?>>> tabs) {
                tabs.computeIfAbsent(ActiniumRuntime.MODID, $ -> new ArrayList<>()).add(Tab.createBuilder()
                        ...
                        .setId(OptionIdentifier.create(ActiniumRuntime.MODID, "shader_packs"))
                        .setOnSelectFunction(() -> {
                            Minecraft.getMinecraft().displayGuiScreen(new ShaderPackScreen(ActiniumVideoOptionsScreen.this));
                            return false;
                        })
                        .build());
            }
