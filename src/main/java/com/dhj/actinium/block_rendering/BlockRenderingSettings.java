...
public final class BlockRenderingSettings {
    ...
    private @Nullable Map<Block, BlockRenderLayer> localBlockTypeIds;
    ...
    public @Nullable Map<Block, BlockRenderLayer> getBlockTypeIds() {
        ...
        Map<Block, BlockRenderLayer> converted = new HashMap<>();
        ...
        for (Map.Entry<?, ?> entry : rawMap.entrySet()) {
            ...
            BlockRenderLayer layer = convertLayer(entry.getValue());
            if (layer != null) {
    ...
    public void setBlockTypeIds(@Nullable Map<Block, BlockRenderLayer> blockTypeIds) {
        Map<Block, BlockRenderLayer> normalized = blockTypeIds == null || blockTypeIds.isEmpty()
                ? null
    ...
    public static @Nullable BlockRenderLayer convertLayer(@Nullable Object value) {
        if (value == null) {
            return null;
        }

        if (value instanceof BlockRenderLayer layer) {
            return layer;
        }
        ...
        return switch (name.toUpperCase(Locale.ROOT)) {
            ...
            case "TRANSLUCENT", "TRIPWIRE" -> BlockRenderLayer.TRANSLUCENT;
            default -> null;
        };
    }
