...
/**
 * Query point for the {@link ItemVertexAlphaOverride}s that make Actinium's fast lit item path
 * unsound.
 *
 * <p>{@code ForgeHooksClient.renderLitItem} is intercepted by Actinium whenever no shader pack is in
