...
public final class NormalHelper {
    ...
    public static void computeFaceNormal(Vector3f saveTo, QuadView quad) {
    ...
    public static int computeTangent(float normalX, float normalY, float normalZ, QuadView quad) {
        final float x0 = quad.x(0);
        final float y0 = quad.y(0);
        final float z0 = quad.z(0);
        final float x1 = quad.x(1);
        ...
        return PackedNormal.pack(tangentX, tangentY, tangentZ, tangentW);
    }
