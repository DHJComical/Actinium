...
public class ScrollBarWidget extends BaseWidget {
    ...
    public void setOffset(int value) {
        this.offset = MathHelper.clamp(value, 0, this.maxContentOffset);
        this.updateThumbLocation();
    ...
    public boolean keyPressed(@NonNull KeyEvent event) {
        ...
        int newOffset = switch (event.key()) {
            case com.dhj.actinium.gui.rso.compat.KeyEvent.KEY_UP -> this.getOffset() - SCROLL_STEP;
            case com.dhj.actinium.gui.rso.compat.KeyEvent.KEY_DOWN -> this.getOffset() + SCROLL_STEP;
    ...
    public void updateNarration(@NonNull NarrationElementOutput builder) {
        ...
        builder.add(NarratedElementType.TITLE, com.dhj.actinium.gui.rso.compat.CommonComponents.optionNameValue(name, Component.literal(percentage + "%")));
        if (this.isFocused()) {
