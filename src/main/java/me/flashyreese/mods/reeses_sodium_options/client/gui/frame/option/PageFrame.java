...
public class PageFrame extends AbstractFrame {
    ...
    public PageFrame(GuiScreen screen, LayoutBounds dim, boolean renderOutline, OptionPage page, RsoModOptions modOptions, OptionStateStore optionStateStore) {
    ...
    private OptionRow getOptionRow(Option<?> option, LayoutBounds dim) {
        ...
        if (optionRow == null || optionRow.getOption().unwrap() != option) {
    ...
    private static @Nullable ResourceLocation optionId(Option<?> option) {
        return PageLayout.optionId(option);
    }
    ...
    public static class Builder {
        ...
        public Builder withPage(OptionPage page) {
            this.page = page;
            return this;
        }

        public Builder withScreen(GuiScreen screen) {
            this.screen = screen;
            return this;
        }

        public Builder withModOptions(RsoModOptions modConfig) {
