...
public class SearchTextFieldWidget extends TextFieldWidget {
    ...
    public SearchTextFieldWidget(LayoutBounds dim, List<RsoModOptions> modOptions, OptionsScreenUiState uiState, int tabDimHeight, Runnable refreshSearchResults) {
    ...
    public void extractRenderState(GuiGraphicsExtractor guiGraphics, int mouseX, int mouseY, float delta) {
        ...
        int textY = buttonBounds.getCenterY() - Minecraft.getMinecraft().fontRenderer.FONT_HEIGHT / 2;
