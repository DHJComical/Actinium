...
public class ScrollableFrame extends AbstractFrame {
    ...
    public ScrollableFrame(LayoutBounds dim, GuiScreen screen, RsoModOptions modOptions, AbstractFrame frame, boolean renderOutline, Holder<Integer> verticalScrollBarOffset, Holder<Integer> horizontalScrollBarOffset) {
