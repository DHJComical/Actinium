 ...
 *
 * <p>Since the 2026 class-path refactor those binary names live under
 * {@code dhj.embeddedt.embeddium.impl}; HBM-CE's mixin still binds the upstream
 * {@code org.embeddedt.embeddium.impl} names and therefore has to migrate with Actinium.</p>
 *
...
class HbmCameraRedirectContractTest {
    private static final String RENDER_SECTION_MANAGER_CLASS =
        "dhj/embeddedt/embeddium/impl/render/chunk/RenderSectionManager";
    private static final String CAMERA_TRANSFORM_CLASS =
        "dhj/embeddedt/embeddium/impl/render/viewport/CameraTransform";
    private static final String UPDATE_DESC =
        "(Ldhj/embeddedt/embeddium/impl/render/viewport/Viewport;IZ)V";
